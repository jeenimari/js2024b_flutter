...
import 'package:JS2024b_app/app/member/info.dart';
import 'package:JS2024b_app/app/member/signup.dart';
import 'package:flutter/material.dart';
import 'package:JS2024b_app/app/product/productList.dart';
        ...
        appBar: AppBar( // 상단 메뉴
          title: Row( // 가로배치
              children: [ // 가로배치할 하위 위젯
                ...
                //     - assets/images/
                Image(
                  image: AssetImage('assets/images/icon.png'), // 로컬이미지 : Image(image: AssetImage('로컬이미지경로'))
                  height: 50, // 이미지 세로 크기
                  width: 50, // 이미지 가로 크기
                ),
